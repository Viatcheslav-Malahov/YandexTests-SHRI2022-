...
export class Game {
    ...
    up(x, y) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            __classPrivateFieldGet(this, _Game_instances, "m", _Game_checkCanMove).call(this, x, y, 4 /* Meta.Top */);
    ...
    down(x, y) {
        return __awaiter(this, void 0, void 0, function* () {
            yield __classPrivateFieldGet(this, _Game_instances, "m", _Game_checkIsKnown).call(this, x, y);
            __classPrivateFieldGet(this, _Game_instances, "m", _Game_checkCanMove).call(this, x, y, 16 /* Meta.Bottom */);
            __classPrivateFieldGet(this, _Game_instances, "m", _Game_markAsKnown).call(this, x, y + 1);
        });
    }
    left(x, y) {
        return __awaiter(this, void 0, void 0, function* () {
            yield __classPrivateFieldGet(this, _Game_instances, "m", _Game_checkIsKnown).call(this, x, y);
            __classPrivateFieldGet(this, _Game_instances, "m", _Game_checkCanMove).call(this, x, y, 32 /* Meta.Left */);
    ...
    right(x, y) {
        return __awaiter(this, void 0, void 0, function* () {
            yield __classPrivateFieldGet(this, _Game_instances, "m", _Game_checkIsKnown).call(this, x, y);
            __classPrivateFieldGet(this, _Game_instances, "m", _Game_checkCanMove).call(this, x, y, 8 /* Meta.Right */);
            __classPrivateFieldGet(this, _Game_instances, "m", _Game_markAsKnown).call(this, x + 1, y);
        });
    }
    state(x, y) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                top: !!(state & 4 /* Meta.Top */),
                bottom: !!(state & 16 /* Meta.Bottom */),
                left: !!(state & 32 /* Meta.Left */),
                right: !!(state & 8 /* Meta.Right */),
                start: !!(state & 1 /* Meta.Start */),
                finish: !!(state & 2 /* Meta.Finish */)
            };
        });
    }
}
_Game_data = new WeakMap(), _Game_height = new WeakMap(), _Game_width = new WeakMap(), _Game_delay = new WeakMap(), _Game_instances = new WeakSet(), _Game_at = function _Game_at(x, y) {
    ...
    __classPrivateFieldGet(this, _Game_data, "f")[x + y * __classPrivateFieldGet(this, _Game_width, "f")] |= 64 /* Meta.Known */;
};
